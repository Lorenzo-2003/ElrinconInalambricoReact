...
export default function UserMenu() {
  ...
  return (
    <div className="user-menu" ref={ref} style={{ position: 'relative' }}>
      ...
      >
        <img src={user.avatar || '/Img/iconousuario.webp'} className="user-icon" style={{ width: 44, height: 44 }} alt="Usuario" />
      </button>
        ...
        <div className="card user-card" style={{ position: 'absolute', right: 0, top: '56px', zIndex: 1000, minWidth: 220 }}>
          <div className="card-body p-3">
            <div className="d-flex align-items-center mb-2">
              <img src={user.avatar || '/Img/iconousuario.webp'} className="user-icon me-2 rounded" style={{ width: 40, height: 40 }} alt="avatar" />
              <div>
            ...
            <div className="d-grid gap-2">
              <button className="btn btn-outline-primary btn-sm" onClick={() => { setOpen(false); navigate('/perfil'); }}>Ver perfil</button>
